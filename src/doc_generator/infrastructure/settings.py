...
class PdfTocSettings(BaseSettings):
    """Table of Contents settings for PDF generation."""

    include_page_numbers: bool = True
    max_depth: int = 3  # H1, H2, H3
    show_reading_time: bool = True
    words_per_minute: int = 200


class PdfCodeSettings(BaseSettings):
    """Code block formatting settings for PDF generation."""

    show_line_numbers: bool = True
    syntax_highlighting: bool = True
    max_lines_per_page: int = 50
    font_size: int = 9
    line_number_color: str = "#888888"


class PdfHeaderFooterSettings(BaseSettings):
    """Header and footer settings for PDF generation."""

    show_header: bool = True
    show_footer: bool = True
    show_page_numbers: bool = True
    include_watermark: bool = False
    watermark_text: str = "Generated by Document Generator"
    watermark_opacity: float = 0.1


class PdfTypographySettings(BaseSettings):
    """Typography settings for PDF generation."""

    font_family: str = "Helvetica"  # or "Times-Roman", "Courier"
    body_font_size: int = 11
    heading_font_size_h1: int = 24
    heading_font_size_h2: int = 18
    heading_font_size_h3: int = 14
    line_spacing: float = 1.5
    use_drop_caps: bool = False


class PdfMetadataSettings(BaseSettings):
    """Document metadata settings for PDF generation."""

    auto_add_metadata: bool = True
    include_generation_date: bool = True
    include_source_url: bool = True
    default_author: str = "Document Generator"
    default_creator: str = "Document Generator v1.0"


class PdfQualitySettings(BaseSettings):
    """Quality assurance settings for PDF generation."""

    max_page_expansion_ratio: float = 1.5
