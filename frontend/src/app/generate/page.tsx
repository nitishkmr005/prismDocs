...
const features: Feature[] = [
  {
    ...
    color: "text-cyan-600",
    bgColor: "bg-gradient-to-br from-cyan-100 to-cyan-50 dark:from-cyan-900/40 dark:to-cyan-950/40",
  ...
  },
  {
    ...
    bgColor: "bg-gradient-to-br from-violet-100 to-violet-50 dark:from-violet-900/40 dark:to-violet-950/40",
    shadowColor: "hover:shadow-violet-500/20",
    defaultOutputFormat: "pptx",
    outputOptions: [
      { value: "pptx", label: "PowerPoint Presentation" },
      { value: "pdf", label: "PDF (from slides)" },
    ],
  },
  {
    id: "image",
    ...
    bgColor: "bg-gradient-to-br from-fuchsia-100 to-fuchsia-50 dark:from-fuchsia-900/40 dark:to-fuchsia-950/40",
  ...
  },
  {
    ...
    color: "text-rose-600",
    bgColor: "bg-gradient-to-br from-rose-100 to-rose-50 dark:from-rose-900/40 dark:to-rose-950/40",
  ...
  },
  {
    ...
    color: "text-teal-600",
    bgColor: "bg-gradient-to-br from-teal-100 to-teal-50 dark:from-teal-900/40 dark:to-teal-950/40",
  ...
  },
  {
    ...
    bgColor: "bg-gradient-to-br from-orange-100 to-orange-50 dark:from-orange-900/40 dark:to-orange-950/40",
  ...
  },
  {
    ...
    bgColor: "bg-gradient-to-br from-purple-100 to-purple-50 dark:from-purple-900/40 dark:to-purple-950/40",
  ...
  },
  {
    ...
    color: "text-blue-600",
    bgColor: "bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/40 dark:to-blue-950/40",
  ...
  },
  {
    ...
    bgColor: "bg-gradient-to-br from-emerald-100 to-emerald-50 dark:from-emerald-900/40 dark:to-emerald-950/40",
